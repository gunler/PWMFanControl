...
IO.setmode (IO.BCM)            # BCM pin numbers - PIN8 as ‘GPIO4’
IO.setup(4,IO.OUT)            # Initialize GPIO14 as our fan output pin
fan = IO.PWM(4,100)           # Set GPIO14 as a PWM output, with 100Hz frequency (this should match your fans specified PWM frequency)
